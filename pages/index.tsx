    ...
    <div>
      ...
      <div className="justify-center flex flex-col h-screen overflow-hidden bg-white">
        ...
        >
          ...
          >
            <SwiperSlide className="h-full w-full justify-center flex flex-col">
              <Waveform
                audio={
        ...
        >
          <div className="flex min-w-0 w-full shadow-md">
            <div className={`flex-auto ml-1 text-sm h-12 truncate`}>
              {expand ? (
                <div className={"info-fade leading-5 mt-0.5 mr-1"}>
                ...
                <div className={"font-bold text-lg mt-2 ml-1 truncate"}>
                  Info
                </div>
              )}
            </div>
          ...
          {!expand && (
            ...
            >
              ...
              <div className="font-bold mt-4">Contents</div>
